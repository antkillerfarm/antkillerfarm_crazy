...
for id in xrange(1, 2001):
    ...
    #predict[0] = predict[0] * 0.95
    #predict[1] = predict[1] * 0.95
    predict[2] = predict[2] * 1.05
    predict[3] = predict[3] * 1.05
    predict[4] = predict[4] * 1.05
    predict[5] = predict[5] * 1.05
    predict[6] = predict[6] * 0.95
    #predict[7] = predict[7] * 0.95
    #predict[8] = predict[8] * 0.95
    #predict[9] = predict[9] * 0.95
    predict[10] = predict[10] * 1.09
    predict[11] = predict[11] * 1.05
    predict[12] = predict[12] * 1.05
    predict[13] = predict[13] * 0.98
