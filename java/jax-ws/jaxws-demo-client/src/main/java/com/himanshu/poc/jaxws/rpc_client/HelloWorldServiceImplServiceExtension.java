...
public class HelloWorldServiceImplServiceExtension extends HelloWorldServiceImplService {
	...
	static {
        ...
        try {
            URL baseUrl;
            baseUrl = gen.com.himanshu.poc.jaxws.stubs.rpc_type.HelloWorldServiceImplService.class.getResource(".");
            url = new URL(baseUrl, "http://localhost:9999/ws/hellorpc");	//Configurable here, read from properties or something
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://localhost:9999/ws/hellorpc', retrying as a local file");
	...
	public HelloWorldServiceImplServiceExtension() {
        super(HELLOWORLDSERVICEIMPLSERVICE_WSDL_LOCATION, new QName("http://rpc_type.service.jaxws.poc.himanshu.com/", "HelloWorldServiceImplService"));
	}
